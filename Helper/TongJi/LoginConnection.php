...
class LoginConnection{
    ...
    public function init($url) {
        $this->url = $url;
        $this->headers = array('UUID: '.Config::UUID, 'account_type: '.Config::ACCOUNT_TYPE, 'Content-Type:  data/gzencode and rsa public encrypt;charset=UTF-8');
    }
